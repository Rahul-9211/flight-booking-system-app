          ...
          >
            <div className="glass-effect rounded-2xl p-6 md:p-8">
              <form onSubmit={handleSearch}>
                ...
                <button
                  type="submit"
                  className="w-full py-4 bg-gradient-to-r from-primary to-secondary rounded-lg text-lg font-medium hover:opacity-90 transition-opacity"
                >
                  Search Flights
                </button>
              </form>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            >
              ...
              <p className="text-white/70">Book your flights in seconds with our streamlined booking process.</p>
            </motion.div>
            ...
            >
              ...
              <p className="text-white/70">Your payment and personal information are always protected.</p>
            </motion.div>
            ...
            >
              ...
              <p className="text-white/70">We guarantee the best prices for your travel needs.</p>
            </motion.div>
          </div>
        </div>
      </div>
